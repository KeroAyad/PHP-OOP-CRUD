...
var form = document.getElementById('type');
    if (value=="DVD"){
        ...
        <div class="mb-3">
            ...
            <input type="number" id="size" step="0.01" class="form-control" name="size" min="0.01" required>
        </div>
        `
    }
    else if (value=="Book"){
        ...
        <div class="mb-3">
            ...
            <input type="number" id="weight" step="0.01" class="form-control" name="weight" min="0.01" required>
        </div>
        `
    }
    else if (value=="Furniture")
    {
        ...
        <div class="mb-3">
            ...
            <input type="number" id="height" step="0.01" class="form-control" name="height" min="0.01" required>
        </div>
        <div class="mb-3">
            <label for="width" class="form-label">Width (CM)</label>
            <div id="help" class="form-text">Please provide width in centimeter format.</div>

            <input type="number" id="width" step="0.01" class="form-control" name="width" min="0.01" required>
        </div>
        <div class="mb-3">
            <label for="length" class="form-label">Length (CM)</label>
            <div id="help" class="form-text">Please provide Length in centimeter format.</div>
            <input type="number" id="length" step="0.01" class="form-control" name="length" min="0.01" required>
        </div>
        `
    }
}
